...
const components = {};
function C_58_47Users_47Victor_47Documents_47nuxt_45projects_47victor_47_46nuxt_47components_46plugin_46mjs(nuxtApp) {
...
const C_58_47Users_47Victor_47Documents_47nuxt_45projects_47victor_47node_modules_47nuxt_47dist_47head_47runtime_47lib_47vueuse_45head_46plugin = defineNuxtPlugin((nuxtApp) => {
...
const C_58_47Users_47Victor_47Documents_47nuxt_45projects_47victor_47node_modules_47nuxt_47dist_47head_47runtime_47plugin = defineNuxtPlugin((nuxtApp) => {
...
const _sfc_main$8 = {
  ...
  async setup(__props) {
    ...
    const props = __props;
    const { data: post } = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => useFetch(`https://peabiru.org.br/wp-json/wp/v2/posts/${props.id}`, {
      pick: ["title", "content"]
    })), __temp = await __temp, __restore(), __temp);
    const title = post.value.title.rendered;
    const content = post.value.content.rendered;
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<article${serverRenderer.exports.ssrRenderAttrs(_attrs)}><h1 class="text-4xl text-blue-400">${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(title))}</h1><div>${vue_cjs_prod.unref(content)}</div></article>`);
    };
  }
};
...
const routes = [
  {
    name: "index",
    path: "/",
    file: "C:/Users/Victor/Documents/nuxt-projects/victor/pages/index.vue",
    children: [],
    meta: meta$1,
    alias: [],
  ...
  },
  {
    name: "post-id",
    path: "/post/:id",
    file: "C:/Users/Victor/Documents/nuxt-projects/victor/pages/post/[id].vue",
    children: [],
    meta,
    alias: [],
    component: () => Promise.resolve().then(function() {
...
const C_58_47Users_47Victor_47Documents_47nuxt_45projects_47victor_47node_modules_47nuxt_47dist_47pages_47runtime_47router = defineNuxtPlugin(async (nuxtApp) => {
...
const _plugins = [
  preload,
  C_58_47Users_47Victor_47Documents_47nuxt_45projects_47victor_47_46nuxt_47components_46plugin_46mjs,
  C_58_47Users_47Victor_47Documents_47nuxt_45projects_47victor_47node_modules_47nuxt_47dist_47head_47runtime_47lib_47vueuse_45head_46plugin,
  C_58_47Users_47Victor_47Documents_47nuxt_45projects_47victor_47node_modules_47nuxt_47dist_47head_47runtime_47plugin,
  C_58_47Users_47Victor_47Documents_47nuxt_45projects_47victor_47node_modules_47nuxt_47dist_47pages_47runtime_47router
];
const _sfc_main$7 = {
  __name: "error-404",
  __ssrInlineRender: true,
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Post = _sfc_main$8;
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "container mx-auto" }, _attrs))}>`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_Post, { id: vue_cjs_prod.unref(id) }, null, _parent));
      _push(`</div>`);
    };
  }
};
